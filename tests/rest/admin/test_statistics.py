...
class StatisticsTestCase(unittest.HomeserverTestCase):
    servlets = [
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_synapse/admin/v1/statistics/server"
...
class ServerStatisticsTestCase(unittest.HomeserverTestCase):
    servlets = [
        synapse.rest.admin.register_servlets,
        login.register_servlets,
    ]
...
class RoomEventStatisticsTestCase(unittest.HomeserverTestCase):
    servlets = [
        synapse.rest.admin.register_servlets,
        login.register_servlets,
    ]
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_synapse/admin/v1/statistics/rooms/count_events"
...
class UserEventStatisticsTestCase(unittest.HomeserverTestCase):
    servlets = [
        synapse.rest.admin.register_servlets,
        login.register_servlets,
    ]
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_synapse/admin/v1/statistics/users/count_events"
