...
from synapse.rest.admin.statistics import (
    ServerStatisticsRestServlet,
    UserEventStatisticsRestServlet,
...
def register_servlets(hs, http_server):
    ...
    ServerStatisticsRestServlet(hs).register(http_server)
    UserEventStatisticsRestServlet(hs).register(http_server)
